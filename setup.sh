...
sudo nix --experimental-features "nix-command flakes" run github:nix-community/disko -- --mode disko --flake github:paysancorrezien/nix#lenovo --no-write-lock-file

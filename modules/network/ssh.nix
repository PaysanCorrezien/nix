...
in
{
  ...
  config = lib.mkIf (cfg.settings.ssh.enable) {
    services.openssh = {
      enable = true;
      settings = {
      ...
      extraConfig = ''
        ...
        MACs hmac-sha2-512-etm@openssh.com,hmac-sha2-256-etm@openssh.com,umac-128-etm@openssh.com,rsa-sha2-512,rsa-sha2-256

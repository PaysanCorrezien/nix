  ...
  config = lib.mkIf config.settings.plasma.extra.enable {
    ...
    programs.plasma = {
      ...
      shortcuts = {
        ...
        "KDE Keyboard Layout Switcher"."Switch to Last-Used Keyboard Layout" = [ "Meta+Alt+L" "Meta+Space,Meta+Alt+L,Basculer vers la dernière disposition de clavier" ];
        "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "none,Meta+Alt+K,Passer à la disposition de clavier suivante";
        ...
        "kwin"."Switch to Desktop 1" = [ "Alt+1,,Passer au bureau 1" ];
        "kwin"."Switch to Desktop 2" = [ "Alt+2,,Passer au bureau 2" ];
        "kwin"."Switch to Desktop 3" = [ "Alt+3,,Passer au bureau 3" ];
        "kwin"."Switch to Desktop 4" = [ "Alt+4,,Passer au bureau 4" ];
        ...
        "kwin"."Switch to Desktop 11" = [ "Alt+N,,Passer au bureau 11" ];
        "kwin"."Switch to Desktop 12" = [ "Alt+Shift+W,,Passer au bureau 12" ];
        ...
        "kwin"."Walk Through Windows" = ",Alt+Tab,Naviguer parmi les fenêtres";
        "kwin"."Walk Through Windows (Reverse)" = ",Alt+Shift+Tab,Naviguer parmi les fenêtres (en ordre inverse)";
        "kwin"."Walk Through Windows Alternative" = [ ];
        "kwin"."Walk Through Windows Alternative (Reverse)" = [ ];
        "kwin"."Walk Through Windows of Current Application" = ",Alt+`,Naviguer parmi les fenêtres de l'application courante";
        ...
        "kwin"."Window Close" = [ "Alt+Shift+Q" "Alt+F4,Alt+F4,Fermer une fenêtre" ];
        ...
        "kwin"."Window to Desktop 1" = "Alt+Shift+!,,Envoyer une fenêtre sur le bureau 1";
        "kwin"."Window to Desktop 2" = "Alt+Shift+@,,Envoyer une fenêtre sur le bureau 2";
        "kwin"."Window to Desktop 3" = "Alt+Shift+#,,Envoyer une fenêtre sur le bureau 3";
        "kwin"."Window to Desktop 4" = "Alt+Shift+$,,Envoyer une fenêtre sur le bureau 4";
        "kwin"."Window to Desktop 5" = "Alt+Shift+%,,Envoyer une fenêtre sur le bureau 5";
        "kwin"."Window to Desktop 6" = "Alt+Shift+^,,Envoyer une fenêtre sur le bureau 6";
        "kwin"."Window to Desktop 7" = "Alt+Shift+&,,Envoyer une fenêtre sur le bureau 7";
        "kwin"."Window to Desktop 8" = "Alt+Shift+*,,Envoyer une fenêtre sur le bureau 8";
        "kwin"."Window to Desktop 9" = "Alt+Shift+(,,Envoyer une fenêtre sur le bureau 9";
        "kwin"."Window to Desktop 10" = "Alt+Shift+),,Envoyer une fenêtre sur le bureau 10";
        ...
        "plasmashell"."next activity" = "Meta+A,none,Parcourir les activités";
        "plasmashell"."previous activity" = "Meta+Shift+A,none,Parcourir les activités (à l'envers)";
        "plasmashell"."repeat_action" = "none,Meta+Ctrl+R,Démarrer manuellement une action concernant le presse-papier actuel";
      ...
      configFile = {
        ...
        "kwinrc"."Windows"."ShadeHover" = true;

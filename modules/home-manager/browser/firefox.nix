   ...
   profiles.dylan = {
	...
	#TODO: add this to firefox nix
      ...
      settings = {
        ...
        "toolkit.legacyUserProfileCustomizations.stylesheets" = true; # mandatory to use a userchrome.css
        "startup.homepage_welcome_url" = "";
        "startup.homepage_welcome_url.additional" = "";
        "extensions.autoDisableScopes" = 0 ; # automatically enable extensions -> https://nix-community.github.io/home-manager/options.xhtml#opt-programs.firefox.profiles._name_.extensions
        ...
        "reader.parse-on-load.force-enabled" = false; # Keep the reader button enabled at all times if set to true; tridactyl :reader allow doing it with a shortcut :)
        "app.shield.optoutstudies.enabled" = false; #tridactyl want this 
        "app.update.auto" = false;
        "browser.contentblocking.category" = "strict";
        "browser.ctrlTab.recentlyUsedOrder" = false;
        "browser.startup.page" = "3"; #BUG: need to be set manually for some reason ?
        "browser.newtabpage.pinned" = false;
        "browser.tabs.tabmanager.enabled" = false; # Remove the tab about right corner https://support.mozilla.org/mk/questions/1394194
        ...
        "services.sync.pref.browser.newtabpage.activity-stream.showSponsored" = false;
        "services.sync.pref.browser.newtabpage.activity-stream.showSponsoredTopSites" = false;
        "services.sync.pref.browser.newtabpage.activity-stream.showSearch" = false;
